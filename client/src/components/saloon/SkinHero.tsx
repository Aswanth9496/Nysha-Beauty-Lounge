...
export default function SkinHero() {
    return (
        <section className="relative w-full h-[35vh] flex items-center justify-center bg-salon-bg2 overflow-hidden">
            <img
                src="/saloon/assets/images/Skin and Beauty.png"
                alt="Skin & Beauty Services Background"
            ...
            <ScrollReveal className="relative z-[2] text-center pt-[60px]">
                <span className="text-[9px] tracking-[6px] text-gold uppercase mb-4 block">Radiant Glow</span>
                <h1 className="font-playfair text-[clamp(40px,6vw,70px)] font-normal leading-[1.1] text-white">
                    Skin & <em className="italic text-gold not-italic">Beauty</em>
                </h1>
            </ScrollReveal>

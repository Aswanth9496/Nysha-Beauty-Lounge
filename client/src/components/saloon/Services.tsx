...
const BOOKING_LINK =
    "https://www.fresha.com/a/nysha-beauty-lounge-dubai-3654-j5p-dubai-jvc-25deg0332-7-n-55deg1219-6-e-dubai-htjn822h/all-offer?menu=true&share=true&pId=2805835";
...
const defaultServices = [
    {
        ...
        name: "Hair Services",
        description:
            "Precision cuts, bespoke color & luxurious styling by master artisans.",
    ...
    },
    {
        ...
        description:
            "Advanced facial rituals and premium skincare for a healthy, luminous glow.",
    ...
    },
    {
        ...
        description:
            "Impeccable manicures, pedicures, and expert lash & brow sculpting.",
    ...
    },
    {
        ...
        description:
            "Editorial glam, bridal elegance, and holistic wellness treatments.",
    ...
    return (
        <section className="py-20 sm:py-[108px] px-5 sm:px-14 max-w-[1440px] mx-auto overflow-hidden">
            <ScrollReveal className="flex flex-col sm:flex-row items-baseline sm:items-end justify-between mb-12 sm:mb-14 gap-6 sm:gap-8">
                <div>
                    <span className="text-[9px] tracking-[5px] sm:tracking-[6px] text-gold uppercase mb-3 sm:mb-4 block">
                        What We Offer
                    </span>
                ...
                <p className="max-w-[340px] text-[12px] sm:text-[13px] text-salon-gray leading-[1.8] sm:leading-[1.85] text-left sm:text-right">
                    Crafted for those who demand the very finest — each
                    treatment a ritual, every visit an experience.
                </p>
            </ScrollReveal>
                        ...
                        <div className="relative h-full overflow-hidden bg-[#181818] border border-white/5 transition-all duration-[0.45s] hover:border-gold/45 sm:hover:-translate-y-[9px] sm:hover:shadow-[0_24px_60px_rgba(0,0,0,0.55),0_0_0_1px_rgba(201,168,76,0.1)]">
                            ...
                            <div className="w-full aspect-[3/4] relative overflow-hidden">
                                <img
                                    src={svc.image}
                                    alt={svc.name}
                                    className="w-full h-full object-cover object-top brightness-[0.85] saturate-[1.05] transition-all duration-[0.65s] group-hover:scale-[1.09] group-hover:brightness-[1.05] group-hover:saturate-[1.15]"
                                />
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-[16px] pb-6 sm:pb-[16px] z-[2]">
                                <h3 className="font-playfair text-xl sm:text-base font-normal text-white leading-tight pointer-events-none">
                                    {svc.name}
                                </h3>

                                <div className="max-h-[60px] sm:max-h-0 overflow-hidden opacity-100 sm:opacity-0 mt-2 sm:mt-0 transition-all duration-[0.45s] ease group-hover:max-h-[60px] group-hover:opacity-100 group-hover:mt-2 pointer-events-none">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-gold to-gold2 scale-x-0 origin-left transition-transform duration-500 group-hover:scale-x-100" />
                        </div>
                    </ScrollReveal>
                ))}
            </div>

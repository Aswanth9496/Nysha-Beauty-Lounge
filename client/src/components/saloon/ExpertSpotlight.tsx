        ...
        <section className="py-27 px-5 sm:px-14 bg-salon-bg2 border-t border-salon-border border-b">
            <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center gap-[70px]">
                <ScrollReveal className="w-full md:w-[380px] flex-shrink-0 aspect-[3/4] relative">
                    <img
                        src="/saloon/assets/images/Hair Service -4.png"
                        alt="Senior Hair Artist"
                ...
                <div className="flex flex-col">
                    <ScrollReveal delay="d1">
                        <span className="text-[9px] tracking-[6px] text-gold uppercase mb-4 block">The Artist</span>
                        <h2 className="font-playfair text-[clamp(30px,3.6vw,50px)] font-normal leading-[1.12] mb-6 text-white">
                            Meet Your<br /><em className="italic text-gold not-italic">Master Stylist</em>
                        </h2>
                    </ScrollReveal>

                    <ScrollReveal delay="d2">
                        <p className="font-playfair text-[22px] text-white mb-1">Aaliya Sharma</p>
                        <p className="text-[9px] tracking-[3px] text-gold uppercase mb-[42px]">Artistic Director & Senior Hair Artist</p>
                    </ScrollReveal>

                    <ScrollReveal delay="d3">
                        <p className="text-[13px] text-salon-gray leading-[1.9] mb-[34px]">
                            &quot;True hair artistry isn&apos;t just about following trends—it&apos;s about engineering the perfect aesthetic for your individual lifestyle, face shape, and natural texture. When you sit in my chair, you are receiving an entirely bespoke architectural design for your hair.&quot;
                        </p>
                        <p className="text-[13px] text-salon-gray leading-[1.9]">
                            With over 12 years of luxury salon expertise gathered globally, Aaliya is Dubai&apos;s sought-after specialist for complex color corrections, seamless balayage, and restorative treatments.
                        </p>

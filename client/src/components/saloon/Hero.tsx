    ...
    return (
        <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-salon-bg">
            ...
            <div className="absolute inset-0 w-full h-full overflow-hidden">
                <img
                    className="absolute inset-0 w-full h-full object-cover object-top filter brightness-[0.75] saturate-[1.1] animate-hero-bg-zoom"
                    src="/saloon/assets/images/salon_interior.png"
                    alt="Luxury salon background"
                />
            </div>

            {/* Side Panels - Female */}
            <div className="absolute top-0 bottom-0 left-0 w-[22%] overflow-hidden z-[1] opacity-0 animate-[fadeIn_1.4s_0.8s_forwards] hidden sm:block">
                <img
                    className="w-full h-full object-cover object-top filter brightness-[0.85] saturate-[1.05] sepia-[0.05] animate-side-zoom"
                    src="/saloon/assets/images/model_female_1.png"
                    alt="Woman beauty"
                />
                <div className="absolute inset-0 bg-gradient-to-r from-salon-bg/70 to-transparent" />
                <div className="absolute inset-0 bg-gradient-to-b from-salon-bg/40 via-transparent to-salon-bg/40" />
            </div>

            {/* Side Panels - Male */}
            <div className="absolute top-0 bottom-0 right-0 w-[22%] overflow-hidden z-[1] opacity-0 animate-[fadeIn_1.4s_0.8s_forwards] hidden sm:block">
                <img
                    className="w-full h-full object-cover object-top filter brightness-[0.85] saturate-[1.05] sepia-[0.05] animate-side-zoom [animation-delay:-11s]"
                    src="/saloon/assets/images/model_male_1.png"
                    alt="Men grooming"
                />
                <div className="absolute inset-0 bg-gradient-to-l from-salon-bg/70 to-transparent" />
                <div className="absolute inset-0 bg-gradient-to-b from-salon-bg/40 via-transparent to-salon-bg/40" />
            </div>
            ...
            <div className="relative z-[3] text-center max-w-[820px] px-8">
                ...
                <div className="opacity-0 animate-[fadeUp_0.9s_1.2s_forwards]">
                    <button className="group relative overflow-hidden font-dm-sans text-[10px] font-light tracking-[4.5px] uppercase py-[17px] px-12 border border-gold text-gold bg-transparent cursor-pointer transition-colors duration-[0.35s] hover:text-[#080808]">
